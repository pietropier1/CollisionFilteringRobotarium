classdef ArenaPlot < handle
    ...
    methods % constructor
        ...
        function arenaPlot = createAgentsplot(arenaPlot,agent)      
            ...
            arenaPlot.PGl = plot(agent(arenaPlot.hero).goal(1,1),agent(arenaPlot.hero).goal(2,1),'g*');
    ...
    methods
        ...
        function arenaPlot = updateAgentsplot(arenaPlot,agent,collCoords)
            ...
            % plot selected agent goal
            set(arenaPlot.PGl,'xdata',agent(arenaPlot.hero).goal(1,1),'ydata',agent(arenaPlot.hero).goal(2,1));
